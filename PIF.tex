...
Simulating forecasts from (\ref{NExperts}) requires a covariance matrix $\bSigma_{22}$ such that $h(\bSigma_{22}) \in \mathcal{S}_{+}^{N+1}$. 
...
%Once the final estimate of $\bSigma_{22}$ has been found,
