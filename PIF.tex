...
%\end{enumerate}
\end{proposition}
\marginpar{Be careful here though. Make a similar claim to the reviewers comment. The aggregator only cares about the total noise in that region etc. Should also prove the form of X''}
