...
\vspace{-4 em}
    ...
    \begin{subfigure}{0.5\textwidth}
                ...
                \subcaption{Prediction errors under different value of $K$ but fixed $N = 20$.}
                \label{Nfixed}
        \end{subfigure}%
        \begin{subfigure}{0.5\textwidth}
                \includegraphics[width=\textwidth]{simResXN.pdf}
                \subcaption{Prediction errors under different value of $N$ but fixed $K = 20$.}
                                \label{Kfixed}
        \end{subfigure}
