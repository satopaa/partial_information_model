...
This paper introduces statistical methodology designed specifically for the rapidly growing practice of prediction polling. The focus, however, is on empirical work. Therefore, the methods are illustrated with case studies of real-world prediction polls.  In particular, the first study analyzes a forecasting tournament initiated in 2011 by the Intelligence Advanced Research Projects Activity (IARPA) as a means to acquire accurate predictions on future international political events. Among the participating teams, the Good Judgment Project (GJP) (\citealt{ungar2012good, mellers2014psychological}) has emerged as the clear winner. 
% This success is largely credited to the
The GJP has performed large-scale prediction polling, recruiting 
...
These forecasters were then asked to estimate probabilities of the events specified by IARPA.  To illustrate, Figure \ref{Examples} shows the forecasts for two of these events: ``Will Moody's issue a new downgrade on the long-term ratings for any of the eight major French banks between 30 July 2012 and 31 December 2012?'' and ``Will the Palestinian group Islamic Jihad significantly violate its cease-fire with Israel before 30 September 2012?". The forecasters were allowed to make and update their estimates until the events resolved. The forecasters, however, reported updates very infrequently. Furthermore, not all forecasters made probability estimates for all the events, making the dataset extremely sparse. 
